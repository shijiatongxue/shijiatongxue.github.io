...
export interface ProjectProps {
  ...
  displayImageBgColor?: ProjectImageProps['bgColor'];
  relatedUrl: string;
  githubUrl?: string;
}
...
export default function Project(props: ProjectProps) {
  ...
  return (
    <div className="flex flex-col items-start gap-y-[20px] w-[309px] h-[465px] rounded-[5px] grow">
      <div className="shrink-0 flex justify-center items-center gap-x-[26px]">
        <p className="shrink-0 min-w-[215px] text-[32px] text-[color:var(--semi-color-text-0)] leading-[57px] text-left align-top font-[500]">
          {name}
        </p>
      </div>
      ...
      <div className="shrink-0 flex items-start gap-x-[20px] pt-[0px] pl-[14px] pr-[0px] pb-[0px]">
        {githubUrl && (
          ...
          >
            <div className="shrink-0 flex items-center gap-x-[4px] text-[color:var(--semi-color-text-0)]">
              <p className="shrink-0 text-[16px] leading-[24px] text-left align-top font-[500]">
                Github
              </p>
        ...
        <div
          className="shrink-0 flex flex-col justify-center items-center gap-y-[4px]"
